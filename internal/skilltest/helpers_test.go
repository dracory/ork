...
func TestSkillTest_Setup(t *testing.T) {
	test := New(t)
	test.Setup()
...
func TestSkillTest_Setup_Cleanup(t *testing.T) {
	test := New(t)
	test.Setup()
	test.Cleanup()
...
func TestSkillTest_ExpectCommand(t *testing.T) {
	test := New(t)
...
func TestSkillTest_ExpectError(t *testing.T) {
	test := New(t)
...
func TestSkillTest_Config(t *testing.T) {
	test := New(t)
	cfg := test.Config()
...
func TestSkillTest_SetArg(t *testing.T) {
	test := New(t)
...
func TestSkillTest_SetArgs(t *testing.T) {
	test := New(t)
...
func TestSkillTest_MockClient(t *testing.T) {
	test := New(t)
...
func TestSkillTest_AssertCommandRun(t *testing.T) {
	test := New(t)
	test.Setup()
	defer test.Cleanup()
...
func TestSkillTest_AssertCommandNotRun(t *testing.T) {
	test := New(t)
	test.Setup()
	defer test.Cleanup()
...
func TestSkillTest_AssertNoError(t *testing.T) {
	test := New(t)

	test.AssertNoError(nil)
}

func TestSkillTest_AssertError(t *testing.T) {
	test := New(t)
	err := errors.New("test error")
...
func TestSkillTest_AssertErrorContains(t *testing.T) {
	test := New(t)
...
func TestSkillTest_AssertResultChanged(t *testing.T) {
	test := New(t)
...
func TestSkillTest_AssertResultUnchanged(t *testing.T) {
	test := New(t)
...
func TestSkillTest_AssertResultNoError(t *testing.T) {
	test := New(t)
...
func TestSkillTest_AssertResultError(t *testing.T) {
	test := New(t)
...
func TestSkillTest_AssertResultMessageContains(t *testing.T) {
	test := New(t)
...
func TestSkillTest_GetCommands(t *testing.T) {
	test := New(t)
	test.Setup()
	defer test.Cleanup()
...
func TestSkillTest_Reset(t *testing.T) {
	test := New(t)
	test.Setup()
	defer test.Cleanup()
