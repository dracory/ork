...
func (m *groupTestMockNode) RunByID(id string, opts ...types.RunnableOptions) types.Results {
	return types.Results{
		Results: map[string]types.Result{
			m.host: {
				Changed: true,
...
func (m *groupTestMockPlaybook) ToMap() map[string]any {
	return map[string]any{
		"id":         m.name,
		"type":       "groupTestMockPlaybook",
		"nodeConfig": m.cfg,
		"dryRun":     m.dryRun,
		"timeout":    m.timeout,
	}
...
func (m *groupTestMockPlaybook) FromMap(mp map[string]any) {
