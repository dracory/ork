...
// TestSecurityAudit_SetRootPassword verifies that SetRootPassword sets the root-password arg.
func TestSecurityAudit_SetRootPassword(t *testing.T) {
	skill := NewSecurityAudit().SetRootPassword("s3cret")
